...
<body>
    ...
    <div class="section1__0 title1"><h2>Opening This week</h2></div>
    ...
    // $var="img/movie5.jpg";
    $q="SELECT * from detail where id>11 and id<22";
    ...
    // $var="img/movie5.jpg";
    $q="SELECT * from detail where id>35 and id<46";
	...
	<div class="grid">
		...
		<div class="Rgrid">
			<div class="cHead">About Company</div>
